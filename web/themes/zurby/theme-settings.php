 ...
 */
function zurby_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['zurby_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zurby sample setting'),
  '#default_value' => theme_get_setting('zurby_example'),
